...
# Load pickle file from save_dir/model/results_nb_scenarios_scenarios_seedrandom_seed_model.pickle
...
# convert the data into data format for conjoint analysis
CrossingSignal_dict = {
  "NA": 0,
  "green": 1,
  "red": 2, 
...
# Save CSV to the same directory as the input pickle
output_file = os.path.join(args.save_dir, str(args.nb_scenarios), args.model, f"shared_responses_{args.model}.csv")
